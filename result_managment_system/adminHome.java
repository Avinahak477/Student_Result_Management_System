...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "cs", "it", "electronic", "civil" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String gen=(String)jComboBox3.getSelectedItem();
        ...
        try{
            ...
            st.executeUpdate("insert into student(roll,course,branch,name,gen,fname) values('"+roll+"','"+course+"','"+branch+"','"+name+"','"+gen+"','"+fname+"')");
